...
public final class JerseyRestUtils {
    ...
    private static <T> T post(String inputString, WebTarget clientResource, Class<T> clazz) throws BlockCypherException {
        ...
        Log.d("JerseyRestUtils", MessageFormat.format("Posting to {0}: {1}", clientResource.getUri(), inputString));
        ...
        if (response.getStatus() != 201) {
            ...
            return GsonFactory.getGson().fromJson(response.readEntity(String.class), clazz);
        }
    }
